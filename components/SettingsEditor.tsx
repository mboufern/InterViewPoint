    ...
    <div className="flex flex-col h-full bg-gray-50">
      <div className="px-8 py-5 border-b border-gray-200 bg-white flex justify-between items-center shadow-sm z-10">
        ...
        <div className="flex gap-2">
            ...
            <button onClick={() => fileInputRef.current?.click()} className="flex items-center gap-2 px-3 py-2 bg-white border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 text-sm font-medium transition">
                <Upload className="w-4 h-4" /> Import
            </button>
            <button onClick={handleExport} className="flex items-center gap-2 px-3 py-2 bg-white border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 text-sm font-medium transition">
                <Download className="w-4 h-4" /> Export
            </button>
            <button onClick={handleReset} className="flex items-center gap-2 px-3 py-2 text-red-600 hover:bg-red-50 rounded-md text-sm font-medium ml-2 transition">
                <RotateCcw className="w-4 h-4" /> Reset
            </button>
            <button onClick={handleSave} className="flex items-center gap-2 px-4 py-2 bg-primary text-white rounded-md hover:bg-primary/90 text-sm font-medium ml-2 shadow-sm transition">
      ...
      <div className="flex-1 overflow-auto p-8">
        <div className="max-w-4xl mx-auto space-y-8 pb-10">
                  ...
                  <div key={key} className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg border border-gray-100 hover:border-primary/20 transition">
                     ...
                     <div className="flex-1">
                        ...
                        <input 
                            ...
                            className="w-full px-3 py-2 border border-gray-300 bg-white rounded-md focus:ring-1 focus:ring-primary focus:border-primary outline-none text-sm transition"
                        />
                     </div>
                     <div className="w-32">
                        <label className="block text-xs text-gray-400 mb-1 font-medium">Score</label>
                        <input 
                            type="number" 
                            value={setting.score} 
          ...
          {/* Indirect Feedbacks */}
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 animate-slide-up" style={{ animationDelay: '0.1s' }}>
            <h2 className="text-lg font-bold text-gray-900 mb-6 pb-2 border-b border-gray-100 flex items-center gap-2">
